...
const fields = [
  ...
  { name: "natureOfInjuryIllness", label: "Nature of Injury / Illness", type: "string" },
  { name: "mechanismOfInjuryIllness", label: "Mechanism of Injury / Illness", type: "string" },
  { name: "agencySourceOfInjuryIllness", label: "Agency / Source of Injury / Illness", type: "string" },
...
export default function InjuryDetailsForm({ onSubmit }: { onSubmit?: (data: any) => void }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const fieldMapping: Record<string, string> = {
      ...
      natureOfInjuryIllness: "natureofinjuryillness",
      mechanismOfInjuryIllness: "mechanismofinjuryillness",
      agencySourceOfInjuryIllness: "agencysourceofinjuryillness",
      emiratesIdOfIP: "emiratesidofip",
      employeeIdOfIP: "employeeidofip",
      ipName: "ipname",
      trade: "trade",
      ipStatus: "ipstatus",
      isLTI: "islti",
      backToWorkDate: "backtoworkdate",
  ...
  .from("injury_details")
  .insert([supabaseData as import("@/integrations/supabase/types").Database["public"]["Tables"]["injury_details"]["Insert"]]);
      if (supabaseError) {
